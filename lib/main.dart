     ...
     home: Scaffold(
       ...
       body: Column(
         children: [
           ...
           Container(
             child: Image(image: NetworkImage('https://asset.kompas.com/crops/UZww9iUgQ6Ia2cSqFdD4e5lwYxE=/180x90:1260x810/750x500/data/photo/2019/10/16/5da6b4a19445d.png'),
             ),
          ),
           Container(
             color: Colors.white,
